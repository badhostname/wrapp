function Invoke-WrappIntune {
    ...
    try {
        ...
        # Try vendored IntuneWin32App relative to the package folder first,
        # then fall back to PSModulePath.
        ...
        # per-package collision outcome for every package that was checked.
        ...
        if (-not $Validate) {
            ...
            # Typed per-package collision outcome. Emitted BEFORE the
        ...
        # Wrapping is one shared operation for every package in this tenant
        ...
        foreach ($Package in $PackagesToProcess) {
            ...
            try {
                switch ($updateMode) {
                    'Create' {
                        ...
                        # Add-IntuneWin32AppFromConfig interleaves upload
            ...
            # Structured outcome for this package's app-creation step. Single
        ...
        # Typed fatal signal. Package '*' = broadcast to every package still
    ...
    # Typed completion signal. Fires on both the success and fatal paths;
