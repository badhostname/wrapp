function Write-Log {
    ...
    process {
        ...
        # Scrub tokens / credentials before formatting. Mirrors
        # AppLogger.Redact on the C# side so the same protection applies
        # to the CMTrace log and any domain-share copy.
