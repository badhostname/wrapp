...
///
/// Phase 13 (D-4). Constants here are the canonical surface for date
/// rendering / parsing &#x2014; the corresponding lint rule (planned for Phase 14)
/// will reject inline <c>"yyyy-MM-dd..."</c> literals outside this file.
/// </summary>
