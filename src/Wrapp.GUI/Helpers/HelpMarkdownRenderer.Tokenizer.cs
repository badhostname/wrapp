    ...
    internal static string PreprocessLegacyFieldLines(string raw)
    {
        ...
        foreach (var rawLine in raw.Split('\n'))
        {
            ...
            if (colonIdx > 0 && colonIdx < 40)
            {
                ...
                // A label holding '[' is a token, not a field name: a paragraph
                // starting "[btn:Filter] opens ..." must not become "**[btn:** ...".
                // (Back-ported from Unwrapped, where the structured guides hit it.)
