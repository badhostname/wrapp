...
public static partial class TemplateService
{
    ...
    // Bootstrap is a long read-modify-write over manifest.json; run it
    ...
    // -----------------------------------------------------------------------
    // Org template pack (files shipped beside the exe)
    // -----------------------------------------------------------------------
    ...
    private static int ResetBuiltInTemplatesCore()
    {
        ...
        // The org pack participates in reset the same way --
    ...
    public static string ApplyTokens(string content, AppSection app)
        // Single shared resolver - the twelve built-ins plus any
