...
{
    // Multi-instance: held for process lifetime by the FIRST instance,
    ...
    /// <summary>
    /// The first instance logs to the configured app.log; concurrent
    ...
    /// <summary>True for app.pidNNN.log / app.pidNNN.M.log instance-log names (stale-log cleanup).</summary>
    ...
    // Org-supplied redaction patterns from defaults.local.json
    ...
    /// <summary>
    /// Org patterns come from defaults.local.json - outside this
    ...
    // Literal VALUES of sensitive custom placeholders. Separate
