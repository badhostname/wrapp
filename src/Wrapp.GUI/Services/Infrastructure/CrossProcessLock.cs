...
/// <summary>
/// Workstream M2: serializes read-modify-write cycles on shared per-user files
/// (settings.json + user-defaults sidecar, Templates\manifest.json) across
/// Wrapp processes, using the same named-mutex pattern the MSAL token cache
/// adopted in Phase 12 (S-4).
/// <para>
...
/// the lock (progress over hang, logged) -- identical to the S-4 choice.
/// </para>
/// <para>
