...
public sealed class MonacoTabService : IDisposable
{
    ...
    // Debounce for ContentChanged (500ms)
    ...
    // G1: the host page is served from the monaco.local virtual host
    ...
    {
        // G4: fail closed -- only the monaco.local host page may feed content.
    ...
    public async Task RefreshAsync()
    {
        ...
        // Renavigate to the fresh editor page and wait for it to load.
        await MonacoHost.NavigateToPageAsync(_webView, PageName);
