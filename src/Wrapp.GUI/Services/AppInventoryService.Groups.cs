...
";
        ...
        try
        {
            ...
            // Apply resolved names to all cached details
        ...
        CancellationToken ct)
    {
        ...
        {
            // Skip tree building entirely for groups with no nested children
...
";
        ...
        HashSet<string> path)
    {
        ...
        // Populate extra properties from the info cache
