...
/// <summary>
/// Phase C (update-flow-and-token-polling-plan): THE close pipeline — the
...
/// variant anymore: updates are never enforced mid-session (policy decision
/// C2), so staying open — Cancel — is always a legal outcome.
///
