...
public static partial class ConfigFileService
{
    ...
    /// <summary>
    /// Hard ceiling on Config.json. Deserialization holds up to three
    ...
    public static AppConfigModel DeserializeFromJson(string json)
    {
        ...
        // Coerce through the string form so a string-typed
    ...
    /// </summary>
    /// <remarks>
    /// Returns a <see cref="SecureString"/> or <c>null</c>.
