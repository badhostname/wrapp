...
public class IntuneWinDecryptOrchestrator
{
        ...
        string? macKey = null)
    {
        ...
        // SEC-7: forward the MAC key when the caller has it so DecryptAsync can
        ...
        string? outputBaseName = null)
    {
        ...
        // local caches are no longer used (see Phase 10 / 0.6.0.0220).
        ...
        if (allKeys.Count == 0)
        {
            ...
            // Phase 16b: the empty-list outcome can mean either "vault is
    ...
    // ------------------------------------------------------------------
    // CSV parsing (moved from ToolsViewModel)
    // ------------------------------------------------------------------
