...
/// <summary>
/// Workstream P: machine-bound values of SENSITIVE custom placeholders.
...
public static class PlaceholderSecureStore
{
    ...
    public static string? GetValue(string name)
    {
        ...
        try
        {
            ...
            // SEC-6: this file has NO legacy plaintext format — SetValue has only
    ...
    private static Dictionary<string, string> LoadEnvelopes(bool strict = false)
    {
        for (var attempt = 1; ; attempt++)
        {
            ...
            {
                // SEC-10: a corrupt store still resets to empty (secrets are
