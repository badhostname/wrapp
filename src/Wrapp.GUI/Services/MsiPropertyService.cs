...
public static class MsiPropertyService
{
    ...
    // Open mode: patch file (required for .msp files)
    ...
    public static string? GetPatchProperty(string mspPath, string propertyName)
    {
        ...
        try
        {
            // MSP files require MSIDBOPEN_PATCHFILE (32) to open the patch database
        ...
        try
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    // Convert ICO bytes to BitmapSource
    ...
    private static BitmapSource? ConvertIcoToBitmapSource(byte[] data)
    {
        try
        {
            ...
            // Pick the largest frame by pixel area
