...
/// <summary>
/// Workstream O: seeds org-shipped defaults (defaults.local.json) into a
...
public static class OrgDefaultsSeeder
{
    ...
    public static bool Apply(AppSettings settings, OrgDefaults org)
    {
        ...
        // ---- Update channel (Workstream D). The feed URL seeds like any
        ...
        // ---- Custom placeholders (Workstream P): add-missing by name, never
