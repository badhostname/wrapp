...
///
/// <para><b>Instance registry (B1)</b> — each process holds an exclusive
...
///
/// <para><b>Close-request channel (B3)</b> — each instance hosts an
...
///
/// <para><b>Update-apply guard (B2)</b> — <c>Local\Wrapp.UpdateInProgress</c>
