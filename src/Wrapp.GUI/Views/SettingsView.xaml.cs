...
public partial class SettingsView : UserControl
{
    public SettingsView()
    {
        ...
        // Perf-plan P2.4: the VM's dirty-check serializer runs only while
    ...
    /// <para>
    /// Phase 15 (S-6): <see cref="PasswordBox.SecurePassword"/> hands the
    ...
    /// <summary>
    /// Workstream P: same PasswordBox write-back pattern for sensitive
