...
# EXE with Parameters - Installs {{EXEFile}} with silent arguments

$EXEFile = "{{EXEFile}}"
$InstallerPath = Join-Path -Path $PSScriptRoot -ChildPath "..\B\$EXEFile"
...
# Common silent switches: /S, /silent, /quiet, /verysilent, -s
# Adjust the ArgumentList for your specific installer
