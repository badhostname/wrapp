...
# Winget Install - Installs {{Name}} via Windows Package Manager

$AppId = "{{Name}}" # Replace with the actual winget package ID (e.g. "Google.Chrome")

# Resolve winget path (may be in different locations depending on context)
...
if (-not (Test-Path $WingetPath)) {
    ...
    Trap-Status "winget not found on this system"
}
