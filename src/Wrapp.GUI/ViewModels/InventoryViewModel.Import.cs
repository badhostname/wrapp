...
public partial class InventoryViewModel
{
    ...
    private async Task ImportToWrappAsync()
    {
        ...
        // Check if we have encryption keys for this app
        var hasKeys = false;
        ...
        try
        {
            // Build a new AppConfigModel from the inventory detail
            stepMeta.Start();
            ...
            // Create a temp workspace and write the config
    ...
    private static void PlaceContent(string filePath, string bundleRoot, AppConfigModel config, ContentType contentType)
    {
        ...
        switch (contentType)
        {
            ...
            case ContentType.CompressedArchive:
                ...
                // Update config with the installer file reference
