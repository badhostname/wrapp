...
public partial class SCCMViewModel : ObservableObject
{
    ...
    /// <summary>
    /// Expands {{Name}} placeholders across the selected package's string
    /// fields and its deployments' string fields - summary confirm dialog
    /// first, mutation only on confirm.
    /// </summary>
    [RelayCommand]
