...
public partial class ToolsViewModel : ObservableObject
{
    ...
    private async Task SaveInspectKeysToVault()
    {
        ...
        // Silent-skip when the vault gate is OFF. Surfaces a
    ...
    // sole source of truth -- the per-workstation local cache was removed.
    ...
    {
        // Silent-skip when the vault gate is OFF. CanSaveBatch
