...
/// <summary>One row of the update-mode step list.</summary>
...
public partial class SplashViewModel : StatusViewModelBase
{
    ...
    // -------------------------------------------------------------------
    // Update mode: the splash doubles as the update screen - step list,
    // honest progress, version info. Driven by UpdateFlowController.
    // -------------------------------------------------------------------
