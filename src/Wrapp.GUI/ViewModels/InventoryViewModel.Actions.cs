...
public partial class InventoryViewModel
{
    ...
    private async Task ExportJsonAsync()
    {
        ...
        {
            // Same row styling as the catalog-export options: a raw string
            // Content never wraps and clips at the dialog edge.
            var label = new System.Windows.Controls.TextBlock
            {
                TextWrapping = System.Windows.TextWrapping.Wrap,
                MaxWidth = 380,
            };
            label.Inlines.Add(new System.Windows.Documents.Run("Nested group expansion")
                { FontWeight = System.Windows.FontWeights.SemiBold });
            var sep = new System.Windows.Documents.Run("  -  ");
            sep.SetResourceReference(System.Windows.Documents.TextElement.ForegroundProperty, "TextMutedBrush");
            label.Inlines.Add(sep);
            var det = new System.Windows.Documents.Run("full member-group trees per assignment");
            det.SetResourceReference(System.Windows.Documents.TextElement.ForegroundProperty, "TextSecondaryBrush");
            ...
            var border = new System.Windows.Controls.Border
            {
                ...
                Padding = new System.Windows.Thickness(8, 4, 12, 4),
                Child = rows,
            };
            border.SetResourceReference(System.Windows.Controls.Border.BorderBrushProperty, "AppBorderBrush");
